...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebFrontToBack.Models.RecentWorks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebFrontToBack.Models.WorkService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebFrontToBack.Models.WorkServiceImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebFrontToBack.Models.WorkService", b =>
                {
                    ...
                    b.HasOne("WebFrontToBack.Models.WorkCategory", null)
                        .WithMany("Services")
            ...
            modelBuilder.Entity("WebFrontToBack.Models.WorkServiceImage", b =>
                {
                    b.HasOne("WebFrontToBack.Models.WorkService", "Service")
                        .WithMany("ServiceImages")
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
